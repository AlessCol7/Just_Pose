...
annotations_file = os.path.join(images_folder, '/Users/alessiacolumban/Just_Pose/POSE.v3i.coco (1)/annotated_images/annotations.json')
                ...
                if reference_keypoints is not None:
                    if len(detected_keypoints) == len(reference_keypoints):
                        ...
                        if similarity >= 0.5:  # Adjust the threshold as needed
                            ...
                            screenshot_folder = '/Users/alessiacolumban/Just_Pose/POSE.v3i.coco (1)/saved_ss'
